      ...
      child: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              width: Consts.homepage_container_scale,
              height: Consts.homepage_container_scale,
                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    ...
                    Positioned(
                      top: 10.0,
                      child: SizedBox(
                        width: Consts.homepage_fabImageiconSize,
                        height: Consts.homepage_fabImageiconSize,
                        child: Image(
